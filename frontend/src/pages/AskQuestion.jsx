    ...
    <div className="mx-20 pt-5 md:col-span-7 grid col-span-9 min-h-screen gap-y-4">
      ...
      <div className=" bg-blue-300 p-6">
        ...
        <p className="fs-body2 mb0">
          Youre ready to programming-related question and this form will help
      ...
      <div className="my-8 border p-4 shadow-lg">
        ...
        <div>
          <input
            type="text"
            className="p-3 w-full my-4 outline outline-1 outline-gray-200 "
          ></input>
        </div>
        <div>
      ...
      <div className="my-8 border p-4 shadow-lg">
        ...
        <div>
          <textarea className="p-3 resize-y w-full h-60 outline outline-1 outline-gray-200 my-4"></textarea>
      ...
      <div className="my-8 border p-4 shadow-lg">
        ...
        <div>
          <textarea className="p-3 my-4 resize-y w-full h-60 outline outline-1 outline-gray-200"></textarea>
          {/* <input type='text' className=' w-full  my-4' ></input> */}
        </div>
        <div>
          <button className=" bg-blue-300 p-3 rounded-full">Next</button>
      ...
      <div className="my-8 border p-4 shadow-lg ">
        ...
        <p>
          Be Add up to 5 tags to describe what your question is about. Start
      ...
      <div>
        <button className=" text-red-600 hover:bg-red-200 p-2">
          Discard Draft
        </button>
      </div>
    </div>
